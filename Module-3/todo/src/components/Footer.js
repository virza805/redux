    ...
    return (
        <div className="mt-4 flex justify-between text-xs text-gray-500">
            ...
            <ul className="flex space-x-1 items-center text-xs">
                <li className={`cursor-pointer ${status === 'All' && 'font-bold text-blue-600'}`} onClick={() => handleStatusChange('All')}>All</li>
                <li>|</li>
                <li className={`cursor-pointer ${status === 'Incomplete' && 'font-bold text-blue-600'}`}  onClick={() => handleStatusChange('Incomplete')}>Incomplete</li>
                <li>|</li>
                <li className={`cursor-pointer ${status === 'Complete' && 'font-bold text-blue-600'}`}  onClick={() => handleStatusChange('Complete')}>Complete</li>
                <li></li>
                <li></li>
                <li
